window.SITE_CONFIG = Object.freeze({
  ...
  footerLinks: {
    Services: [
      ['Wildlife Removal', 'wildlife-removal.html'],
      ['Attic Cleanup & Restoration', 'attic-cleanup-restoration.html'],
      ['Entry Point Sealing & Prevention', 'entry-point-sealing-prevention.html']
    ],
    Company: [
      ['About us', 'index.html#about'],
      ['How it works', 'index.html#how-it-works'],
      ['Why it matters', 'index.html#why-it-matters'],
      ['FAQ', 'index.html#faq']
    ],
    Legal: [
